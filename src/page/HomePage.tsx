        ...
        <main className="flex">
          <section className="mx-auto lg:h-281.75  md:h-250 min-h-screen w-full h-full">
            <img 
              ...
              alt=""  
              className="absolute  inset-0 h-full w-full object-cover mask-b-from-50%"  
            />
            ...
            <div className="relative mx-auto max-w-4xl rounded-3xl border border-neutral-200/50 bg-neutral-100 p-2 backdrop-blur-lg dark:border-neutral-600 dark:bg-neutral-700/50 md:p-4">
              <div className="rounded-3xl border border-neutral-200 bg-white p-2 dark:border-neutral-700 dark:bg-black">
                <img src="src\assets\dashboard-new.webp" alt="" className="rounded-[20px]" />
              </div>
            </div>
